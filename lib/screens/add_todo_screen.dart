      ...
      if (kIsWeb) {
        await showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text(
              'Aktivitas berhasil ditambahkan!\n\nKarena Anda menambahkannya dari Web, mohon buka aplikasi ToDo App di HP Anda sekali agar alarm pengingat dapat disinkronkan dan berbunyi tepat waktu di HP Anda.',
